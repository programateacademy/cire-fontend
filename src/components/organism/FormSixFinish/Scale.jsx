...
//     console.log(`formData en local storage: ${localStorage.getItem('formData')}`);
...
//     event.preventDefault(); // evita que la página se refresque al hacer submit
//     localStorage.setItem('formData', JSON.stringify(formValues));
...
//         <select name="question1" value={formValues.question1} onChange={handleInputChange}>
...
//         <select name="question2" value={formValues.question2} onChange={handleInputChange}>
//           <option value="1">1</option>
//           <option value="2">2</option>
//           <option value="3">3</option>
//         </select>
...
//         <select name="question3" value={formValues.question3} onChange={handleInputChange}>
//           <option value="1">1</option>
//           <option value="2">2</option>
//           <option value="3">3</option>
//         </select>
...
//         <select name="question4" value={formValues.question4} onChange={handleInputChange}>
//           <option value="1">1</option>
//           <option value="2">2</option>
//           <option value="3">3</option>
//         </select>
...
//         <select name="question5" value={formValues.question5} onChange={handleInputChange}>
//           <option value="1">1</option>
//           <option value="2">2</option>
//           <option value="3">3</option>
//         </select>
...
//         <select name="question6" value={formValues.question6} onChange={handleInputChange}>
//           <option value="1">1</option>
//           <option value="2">2</option>
//           <option value="3">3</option>
//         </select>
...
//         <select name="question7" value={formValues.question7} onChange={handleInputChange}>
//           <option value="1">1</option>
//           <option value="2">2</option>
//           <option value="3">3</option>
//         </select>
...
//         <select name="question8" value={formValues.question8} onChange={handleInputChange}>
//           <option value="1">1</option>
//           <option value="2">2</option>
//           <option value="3">3</option>
//         </select>
...
//         <select name="question9" value={formValues.question9} onChange={handleInputChange}>
//           <option value="1">1</option>
//           <option value="2">2</option>
//           <option value="3">3</option>
//         </select>
...
//         <select name="question10" value={formValues.question10} onChange={handleInputChange}>
//           <option value="1">1</option>
//           <option value="2">2</option>
//           <option value="3">3</option> 
...
const Cognoscitivo = ({ formData, x, setX }) => {
  const [formValues, setFormValues] = useState(() => {
    const savedFormData = JSON.parse(localStorage.getItem('formData'));
    return savedFormData || { question1: '', question2: '', question3: '' };
  });
  ...
  return (
    ...
    >
      ...
      <form onSubmit={handleFormSubmit}>
        ...
        <label>¿Le ha costado trabajo tener interés en divertirse?</label>
        <select name="question2" value={formValues.question2} onChange={handleInputChange}>
          <option value="">Seleccione una opción</option>
          <option value="1">1</option>
          <option value="2">2</option>
        ...
        <label>¿Le ha costado trabajo relajarse?</label>
        <select name="question3" value={formValues.question3} onChange={handleInputChange}>
          <option value="">Seleccione una opción</option>
          <option value="1">1</option>
          <option value="2">2</option>
