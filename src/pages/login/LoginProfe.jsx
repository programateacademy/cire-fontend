    ...
    return (
        <div className='grid grid-cols-1 sm:grid-cols-2 h-screen w-full'>
            ...
            placeholder="Ingrese su correo electrónico" value={email} onChange={(event) => setEmail(event.target.value)}  required/>
                    ...
                    <button className='w-full my-5 py-2 bg-lime-600 shadow-lg text-white' type="submit"> Sing In </button>
                    <Link to={"/loginAdmin"}>
                    <button className=' w-52 my-5 py-2 bg-lime-600 shadow-lg text-white' type="submit"> Soy Administrador </button>
                    </Link>
                </form>
            </div>
        </div>
