...
export const EditProfessional = ({ setOpenModalEdit }) => {
  ...
  useEffect(() => {
    axios.get(`http://localhost:3000/professionals/${id}`).then(res => {
  ...
  function editProfessionals(){
    ...
    axios.put(`http://localhost:3000/professionals/${id}`, editprofessionals)
      .then(res => {
  ...
  return (
    ...
    <div className='bg-indigo-100'>
        ...
        <button className='bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-11 rounded justify-items-center' onClick={editProfessionals}>Enviar</button>
    </div>
    </div>
    </div>
  );
